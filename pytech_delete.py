...
# call the find_one() method by student_id 1820
student_test_doc = students.find_one({"student_id": "1820"})
...
deleted_student_test_doc = students.delete_one({"student_id": "1820"})
