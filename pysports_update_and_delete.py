...
config = {
    "user": "Jacob_Koscinski",
    "password": "C@Liahbear16!",
    "host": "localhost",
    "database": "pysports",
...
try:
    ...
    update_player = ("UPDATE player SET team_id = 2, first_name = 'John', last_name = 'Wick' WHERE first_name = 'Jacob'")
